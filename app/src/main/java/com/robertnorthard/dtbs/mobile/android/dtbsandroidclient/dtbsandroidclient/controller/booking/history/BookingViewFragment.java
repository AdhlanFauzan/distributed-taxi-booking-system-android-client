...
public class BookingViewFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_booking_view, container, false);

        this.bookingCost = (TextView)v.findViewById(R.id.txt_booking_view_cost);
        this.bookingCostDescription = (TextView)v.findViewById(R.id.txt_booking_view_cost_description);
        this.bookingReference = (TextView)v.findViewById(R.id.txt_booking_view_id);
        this.startAddress = (TextView)v.findViewById(R.id.txt_booking_view_pickup_address);
        this.destinationAddress = (TextView)v.findViewById(R.id.txt_booking_view_destination_address);
        this.bookingTime = (TextView)v.findViewById(R.id.txt_booking_view_book_time);
