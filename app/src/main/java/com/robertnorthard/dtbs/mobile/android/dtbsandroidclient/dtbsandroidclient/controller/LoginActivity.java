...
import com.robertnorthard.dtbs.mobile.android.dtbsandroidclient.dtbsandroidclient.service.gcm.GcmRegistrationIntentService;
...
/**
 * A controller for managing events related to the login view.
 *
...
public class LoginActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnForgotPassword = (Button) findViewById(R.id.btn_forgotten_password);
                ...
                /* Async authentication task to prevent blocking UI thread */
                    new AsyncTask<String, Void, Account>() {
                        ...
                        protected void onPreExecute() {
                            this.dialog.setMessage(getString(R.string.progress_sign_in_message));
                            this.dialog.show();
                        }
